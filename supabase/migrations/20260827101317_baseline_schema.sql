-- =====================================================================
-- Baseline migration — Platform Phase 0 — Foundation
--
-- This migration captures the schema that already existed as the
-- hand-applied `supabase/schema.sql` before this repository had a
-- versioned migration history. It is copied verbatim (no behavior
-- change) so the CMS/blog/tools schema that already runs in production
-- becomes migration-history-tracked instead of a single un-versioned
-- file, satisfying Phase 0's "migration convention and baseline
-- rehearsal" requirement.
--
-- `supabase/schema.sql` remains as a human-readable snapshot reference;
-- from this point forward, schema changes belong in a new numbered
-- migration file, never in schema.sql or in an edit to this file — see
-- supabase/migrations/README.md for the naming/ownership and
-- roll-forward convention.
-- =====================================================================
